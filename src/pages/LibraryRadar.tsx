...
import rfidSecurityGate2 from '@/assets/products/rfid-security-gate-2.webp';
import rfidSecurityGate3 from '@/assets/products/rfid-security-gate-3.webp';
  ...
  return (
    <Layout>
      <Seo
        ...
        description="Library Radar by System One Ltd — RFID library management system for Kenya. How RFID improves library efficiency in Kenya — library RFID Kenya, RFID book tagging Kenya, RFID for universities, RFID for colleges, tags, security gates, self-service kiosks and stocktaking that work with Koha and other LMS."
