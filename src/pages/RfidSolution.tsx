...
const solutions: Solution[] = [
  {
    ...
    summary: 'RFID library management in Kenya — faster circulation, dependable inventory visibility, and stronger resource protection for schools, universities and public libraries.',
  ...
  },
  {
    ...
    summary: 'RFID asset tracking for businesses in Kenya — keep a clearer record of where equipment and valuable assets are, who uses them, and how they move through your organization.',
  ...
  },
  {
    ...
    summary: 'RFID inventory control in Kenya — improve stock visibility and counting accuracy across stores, shelves, warehouses, and operational supply areas.',
  ...
  },
  {
    ...
    summary: 'RFID security gates for libraries in Kenya — monitor tagged items at controlled exit points and help teams respond when protected resources move without authorization.',
  ...
  },
  {
    ...
    title: 'Tags & Readers',
    image: rfidTag,
    summary: 'RFID tags and readers in Kenya — select the tags, desktop readers, handheld scanners and scanning devices that make identification practical in your specific operating environment.',
  ...
  },
  {
    ...
    summary: 'RFID attendance and identification systems in Kenya — support faster, more consistent attendance and identity workflows at access points, service desks, and institutional facilities.',
  ...
  },
  {
    ...
    image: rfidSecurityGate,
    summary: 'RFID access control in Kenya — coordinate credentials, permissions, and controlled entry so people can access the spaces and resources they are authorized to use.',
