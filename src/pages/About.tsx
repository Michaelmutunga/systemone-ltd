  ...
  return (
    <Layout>
      <Seo
        ...
        description="System One Ltd is Kenya's trusted RFID and education technology partner for universities, TVET colleges and institutions. Learn about our RFID solutions and services."
        canonicalPath="/about"
        schema={schema}
      />
      {/* Hero Section */}
