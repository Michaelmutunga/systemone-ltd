  ...
  return (
    <Layout>
      <Seo
        ...
        description="CampusCURA by System One Ltd — RFID technology for smart campuses in Kenya. Education ERP for schools, colleges and universities. RFID campus security Kenya, RFID for universities, RFID for colleges, student, finance, attendance and library management with RFID and biometrics integration."
