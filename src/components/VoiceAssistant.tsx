...
const VoiceAssistant = () => {
  ...
  // Initialize Vapi
  useEffect(() => {
    const vapiInstance = new Vapi('YOUR_VAPI_PUBLIC_KEY'); // Replace with your Vapi public key
  ...
  const startCall = async () => {
    ...
    try {
      ...
      await vapi.start('YOUR_ASSISTANT_ID'); // Replace with your Vapi assistant ID
